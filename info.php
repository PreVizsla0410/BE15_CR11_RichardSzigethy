...
if ($_GET['animal_id']) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $orgin = $data['orgin_and_treatment'];
...
<div class="container d-flex justify-content-center">
           ...
           <img src="products/pictures/<?= $picture;?>" class="card-img-top mt-4" >
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><p class="card-text">Orgin <?php echo $orgin ?></p></li>
                ...
                <div class="card-body d-flex justify-content-evenly">
                    ...
                    <a href="adopt.php?animal_id=<?php echo $animal_id ?>"><button class='btn btn-success' type='button' title='Adopt Pet'>Adopt</button><a>
                </div>
       </div>
       </div>
       <footer>
