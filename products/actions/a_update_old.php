...
if ($_POST) {    
    ...
    $picture = file_upload($_FILES['picture'], 'product');//file_upload() called  
     if($picture->error===0){
        ...
        $sql = "UPDATE animals SET name = '$name', orgin_and_treatment = '$orgin', description = '$description', size = '$size', age = '$age', hobbies = '$hobbies', breed = '$breed', status = '$status' WHERE animal_id = {$animal_id}";
   }    
