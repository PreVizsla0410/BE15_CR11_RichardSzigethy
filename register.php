...
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO user(first_name, last_name, password,  u_address, email, picture,phone )
...
<div class="container d-flex justify-content-center">
   <form class="w-50 bg-light p-3 m-5" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="text"  name="u_address" class="form-control mt-2" placeholder="Enter Your Address" maxlength="50" value ="<?php echo $address ?>"/>
