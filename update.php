...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {       
        ...
        $sql = "UPDATE user SET first_name = '$f_name', last_name = '$l_name', email = '$email', phone = '$phone', u_address = '$address', picture = '$pictureArray->fileName' WHERE user_id = {$id}";
    } else {
        $sql = "UPDATE user SET first_name = '$f_name', last_name = '$l_name', email = '$email', phone = '$phone', u_address = '$address' WHERE user_id = {$id}";
    }
    ...
    <div class="<?php echo $class; ?>" role="alert">
        ...
        <form method="post" enctype="multipart/form-data">
            <table class=" table">
                ...
                <tr>
                    <th>Address</th>
                    <td><input class="form-control" type="text" name="u_address" placeholder= "Address" value= "<?php echo $address ?>" /></td>
                </tr>
                <tr>
                    <th>Picture</th>
