...
if ($_POST) {   
    ...
    $orgin = $_POST["orgin_and_treatment"];
    ...
    if($picture == 'none'){
        $sql = "INSERT INTO animals (name, picture, orgin_and_treatment, description, size, age, hobbies, breed, status) 
                 VALUES   ('$name','$picture->fileName','$orgin','$description','$size','$age','$hobbies','$breed','$status')";
    }else {
