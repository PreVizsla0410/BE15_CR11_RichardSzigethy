    ...
    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){        
        $tbody .= "<tr>
            <td><img src='products/pictures/".$row['picture']."' class='card-img-top' alt='...'></td> 
              ...
              <td>" .$row['status']."</td>
              <td> 
                <a href='info.php?animal_id=" .$row['animal_id']."'><button class='btn btn-primary' type='button' title='Adopt Pet'>Adopt</button></a>
              </td>           
        </tr>   
      ";
    };
...
<?php require_once 'components/navigation1.php'?>
    ...
    <h4 class="title m-3" > Here you can adopt an animal</h4>
    <div class="d-flex justify-content-start mt-4 mb-3">
     <a href="home.php"  class="btn btn-primary btn-sm m-1">Show all pets </a>
     <a href="home.php?Senior='Senior'" class="btn btn-primary btn-sm m-1"  role="button">Old pets</a>
     </div>
     <div class="container">
